...
h_Kminus_long_trans = f.Get("Kminus_NA49_nue")

c4 = TCanvas("c1","c1",1500,1100)

h_Kminus_long_trans.SetTitle("#nu_{e} s from K^{-}")
h_Kminus_long_trans.GetXaxis().SetTitle("x_{F} ")
...
h_Kminus_long_trans.GetXaxis().SetRangeUser(-0.04,1)
h_Kminus_long_trans.GetYaxis().SetRangeUser(0,3.5)
h_Kminus_long_trans.Draw("colz")

# Gemma Tinti's (MINOS thesis) Kminus / Kminus measurements (NA49, thin target, @158 GeV,  so with tgptype particle) [FERMILAB-THESIS-2010-44]
